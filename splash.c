...
int main() {
    ...
    // Delay for approximately 3 seconds=3,000,000,000 ns, artificial delay may change according to device performance 
    for (volatile long long i = 0; i < 3000000000; i++); 
    
    #ifdef _WIN32
        system("cls"); //Clear command for Windows
    #else
        system("clear"); //Clear command for Linux/macOS
    #endif
